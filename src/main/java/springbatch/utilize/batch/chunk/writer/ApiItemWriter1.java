...
public class ApiItemWriter1 extends FlatFileItemWriter<ApiRequestVO> {
    ...
    public ApiItemWriter1(AbstractApiServices apiServices) {
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("C:\\Users\\jakie\\OneDrive\\바탕 화면\\로드맵\\utilize\\utilize\\src\\main\\resources\\product1.txt"));
