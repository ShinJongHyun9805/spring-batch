...
public class ApiItemWriter4 extends FlatFileItemWriter<ApiRequestVO> {

    private final AbstractApiServices apiServices;

    public ApiItemWriter4(AbstractApiServices apiServices) {
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("C:\\Users\\jakie\\OneDrive\\바탕 화면\\로드맵\\utilize\\utilize\\src\\main\\resources\\product4.txt"));
